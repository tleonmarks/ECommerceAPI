...
VALUES 
('Tinashe', 'tina@example.com', 'Some Street, Some City, Some State, 12345'),
('leo', 'leo@example.com', 'Other Street, Other City, Other State, 67890'),
('maka', 'maka@example.com', 'Another Street, Another City, Anothe rState, 13579');
